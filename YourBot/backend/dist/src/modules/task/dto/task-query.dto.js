...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], TaskQueryDto.prototype, "page_size", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], TaskQueryDto.prototype, "requirement_id", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], TaskQueryDto.prototype, "owner_id", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(enums_1.TaskStatus, {
        message: `status must be one of: ${Object.values(enums_1.TaskStatus).join(', ')}`,
    }),
